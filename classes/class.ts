...
class studentPoint {
 ...
 static getPositionOfClosesetStudent(){
    const myInfo = studentPoint.totalStudent;
    let myResult:iResultData[]= [];
    for (let i of myInfo){
        if(i.name === studentPoint.totalStudent[0].name){
            console.log("");
        }
...
console.log(studentPoint.getPositionOfClosesetStudent());
